...
```bash
gh issue create --title "[chore] Claude Code 하네스 구성" --body "..."
```
...
```bash
gh pr create --title "chore: Claude Code 하네스 구성" --body "$(cat <<'EOF'
## 🔎 작업 내용
- ...
...
git pull
git checkout -b "chore/#N-claude-harness-setup"

# 3. 작업 + 커밋
git add ...
git commit -m "chore: Claude Code 하네스 구성"

# 4. push
git push -u origin "chore/#N-claude-harness-setup"

# 5. PR
gh pr create --title "chore: Claude Code 하네스 구성" --body "..."
```
