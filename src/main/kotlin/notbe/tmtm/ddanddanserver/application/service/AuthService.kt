...
class AuthService(
    ...
    fun login(
        ...
        val oAuth: notbe.tmtm.ddanddanserver.application.processor.OAuthInfo = getOAuthInfo(oAuthAccessToken, oAuthType)
    ...
    private fun getOAuthInfo(
        accessToken: String,
        oAuthType: OAuthType,
    ): notbe.tmtm.ddanddanserver.application.processor.OAuthInfo {
